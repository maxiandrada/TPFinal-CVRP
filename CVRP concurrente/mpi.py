...
direccion = "C:\\Users\\Maxi\\Documents\\UNSA\\LAS\\5to Año\\1er cuatrimestre\\Optativa (Opt. Conc. y Paralela)\\TPFinal_CVRP\\TPFinal CVRP\\Instancias"
...
time = 1.0
cvrp = CVRP(matrizDist, demandas, nroVehiculos, capacidad, nombre+"_"+str(time)+"min", 0, tenureADD, tenureDROP, time, optimo)
